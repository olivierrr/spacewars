...
var game = {
  ...
  start:function(){
	...
	//The map is broken into square tiles of this size 20x20px

	gridSize:20,

	//Store whether background moved and needs to be redrawn
	...
	offsetX:0,
	offsetY:0,
	panningThreshold:60, //Distance from edoge of canvas at which panning starts
	panningSpeed:10,
	...
	remove:function(item){
		...
		//Remove items for the type specific array
